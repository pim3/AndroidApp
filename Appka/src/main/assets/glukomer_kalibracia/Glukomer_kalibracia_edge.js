...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            display:'none',
            type:'image',
            rect:['50%','10.3%','50.4%','79.4%','auto','auto'],
            fill:["rgba(0,0,0,0)",'edge_includes/images/prerobenaRuka.png','0px','0px']
         }],
         symbolInstances: [
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid431", tween: [ "style", "${_prerobenaRuka}", "left", '42.33%', { fromValue: '49.58%'}], position: 5628, duration: 872 },
            ...
            { id: "eid432", tween: [ "style", "${_prerobenaRuka}", "top", '8.89%', { fromValue: '10.28%'}], position: 5628, duration: 872 },
            ...
            { id: "eid429", tween: [ "style", "${_xxxx2}", "display", 'block', { fromValue: 'none'}], position: 8086, duration: 0 },
            ...
            { id: "eid430", tween: [ "style", "${_prerobenaRuka}", "display", 'block', { fromValue: 'none'}], position: 5628, duration: 0 },
            { id: "eid433", tween: [ "style", "${_prerobenaRuka}", "display", 'block', { fromValue: 'block'}], position: 7000, duration: 0 },
            { id: "eid434", tween: [ "style", "${_prerobenaRuka}", "display", 'none', { fromValue: 'block'}], position: 7023, duration: 0 },
