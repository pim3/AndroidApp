...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            display:'none',
            type:'image',
            rect:['0%','-5.8%','85.8%','62.1%','auto','auto'],
            fill:["rgba(0,0,0,0)",'edge_includes/texts/ulo%C5%BEenie.png','0%','0%','100%','100%']
         },
         {
            id:'glukomer6',
            display:'none',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid427", tween: [ "style", "${_uloenie}", "opacity", '1', { fromValue: '0'}], position: 8086, duration: 914 },
            ...
            { id: "eid350", tween: [ "style", "${_uloenie}", "display", 'block', { fromValue: 'none'}], position: 8086, duration: 0 },
            ...
            { id: "eid404", tween: [ "style", "${_uloenie}", "width", '83.65%', { fromValue: '83.65%'}], position: 8086, duration: 0 },
            ...
            { id: "eid403", tween: [ "style", "${_uloenie}", "height", '51.25%', { fromValue: '51.25%'}], position: 8086, duration: 0 },
            ...
            { id: "eid418", tween: [ "style", "${_uloenie}", "left", '0%', { fromValue: '0%'}], position: 8086, duration: 0 },
